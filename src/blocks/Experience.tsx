      ...
      <div className="container">
        <div className="experience__intro">
          ...
          <p className="experience__small-description">
            Lorem ipsum Do commodo in proident enim
            in dolor cupidatat adipisicing dolore officia
            nisi aliqua incididunt Ut veniam lorem ipsum Consectetur ut in in
            eu do.
          </p>
        </div>
              ...
              <div className="grid__item grid__item--6-12">
                <div className="experience__content">
                  ...
                  <p className="experience__details">
                    ...
                    culpa nisi ex in magna
                    consectetur nisi
                    cupidatat laboris esse eiusmod deserunt
                    aute do quis velit esse
                    sed Ut proident cupidatat
                    nulla esse
                    cillum laborum
            ...
            <div className="grid">
              ...
              <div className="grid__item grid__item--6-12">
                <div className="experience__content">
                  ...
                  <p className="experience__details">
                    Lorem ipsum Occaecat do esse
                    ex et dolor culpa nisi ex in magna
                    consectetur nisi cupidatat laboris
                    esse eiusmod deserunt aute do quis
                    velit esse sed Ut proident cupidatat
                    nulla esse cillum laborum occaecat
                    nostrud sit dolor incididunt amet est
                    occaecat nisi
                    incididunt.
                  </p>
                </div>
            ...
            <div className="grid">
              ...
              <div className="grid__item grid__item--6-12">
                <div className="experience__content">
                  ...
                  <p className="experience__details">
                    Lorem ipsum Occaecat do esse ex et dolor
                    culpa nisi ex in magna consectetur nisi cupidatat
                    laboris esse eiusmod deserunt aute do quis velit
                    esse sed Ut proident cupidatat nulla esse cillum
                    laborum occaecat nostrud sit dolor incididunt amet
                    est occaecat nisi incididunt.
                  </p>
                </div>
              </div>
            </div>
